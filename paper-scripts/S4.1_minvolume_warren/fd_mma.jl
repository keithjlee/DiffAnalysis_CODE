...
# solve
res = constrained_optimization_FD(params, OBJ, CSTR, alg, opts);
...
# save data
# jldsave(datadir * "07_25_2024_fd_mma.jld2"; results = res)
# GHsave(model_opt, datadir * "07_25_2024_fd_mma.json")